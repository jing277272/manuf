# Generated by Django 3.1.6 on 2021-02-21 18:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('priority', models.CharField(choices=[('success', '低'), ('warning', '中'), ('danger', '高')], default='danger', max_length=12, verbose_name='优先级')),
                ('status', models.SmallIntegerField(choices=[(2, '处理中'), (6, '已关闭'), (4, '已忽略'), (1, '新建'), (3, '已解决'), (7, '重新打开'), (5, '待反馈')], default=1, verbose_name='状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.SmallIntegerField(choices=[(2, '#f28033'), (3, '#ebc656'), (7, '#20bfa3'), (6, '#7461c2'), (4, '#a2d148'), (5, '#20bFA4'), (1, '#56b8eb')], default=1, verbose_name='颜色')),
