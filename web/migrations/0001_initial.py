# Generated by Django 3.1.6 on 2021-07-06 17:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('priority', models.CharField(choices=[('warning', '中'), ('danger', '高'), ('success', '低')], default='danger', max_length=12, verbose_name='优先级')),
                ('status', models.SmallIntegerField(choices=[(6, '已关闭'), (2, '处理中'), (4, '已忽略'), (5, '待反馈'), (7, '重新打开'), (1, '新建'), (3, '已解决')], default=1, verbose_name='状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.SmallIntegerField(choices=[(3, '#ebc656'), (1, '#56b8eb'), (6, '#7461c2'), (5, '#20bFA4'), (7, '#20bfa3'), (4, '#a2d148'), (2, '#f28033')], default=1, verbose_name='颜色')),
