    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.SmallIntegerField(choices=[(3, '已解决'), (7, '重新打开'), (2, '处理中'), (5, '待反馈'), (1, '新建'), (4, '已忽略'), (6, '已关闭')], default=1, verbose_name='状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('category', models.SmallIntegerField(choices=[(1, '免费版'), (3, '其他'), (2, '收费版')], default=2, verbose_name='收费类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.SmallIntegerField(choices=[(3, '#ebc656'), (4, '#a2d148'), (5, '#20bFA4'), (7, '#20bfa3'), (1, '#56b8eb'), (2, '#f28033'), (6, '#7461c2')], default=1, verbose_name='颜色')),
