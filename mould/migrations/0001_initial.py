...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('imgs', models.ImageField(blank=True, null=True, upload_to='repair/')),
                ('modify_time', models.DateTimeField(auto_now_add=True, verbose_name='修改时间')),
                ('local', models.CharField(blank=True, max_length=20, null=True, verbose_name='货位号')),
                ('quantity', models.PositiveIntegerField(blank=True, null=True, verbose_name='在库数量')),
