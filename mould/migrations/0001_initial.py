    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model', models.CharField(max_length=40, verbose_name='规格型号')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('1', '冲头'), ('2', 'TD镶块'), ('5', '其它'), ('0', '凹模'), ('3', '斜楔'), ('4', '成型镶块')], default='0', max_length=2, verbose_name='类型')),
                ('imgs', models.ImageField(blank=True, null=True, upload_to='', verbose_name='照片')),
                ('modify_time', models.DateTimeField(auto_now_add=True, verbose_name='修改时间')),
